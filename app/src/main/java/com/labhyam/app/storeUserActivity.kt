...
class storeUserActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btnadd.setOnClickListener {
            ...
            if (selectedCityPosition == 0) {
                ...
                Utils.toast("storename name can't be empty", this@storeUserActivity)
            }
                ...
                Utils.showDialog(this@storeUserActivity, "Loading")
                val obj = JsonObject()
                    ...
                    it.addcustomerstore(obj)
                        ...
                        .subscribe(object : SingleObserver<BaseResponse> {
                            ...
                            override fun onSuccess(t: BaseResponse) {
                                Utils.hideDialog()
                                if (t.isIsvalid()){
                                    Toast.makeText(this@storeUserActivity, "store created successfully", Toast.LENGTH_SHORT).show()
                                    Intent(this@storeUserActivity, HomepageActivity::class.java).also {
                                    ...
                                    Toast.makeText(this@storeUserActivity, t.message, Toast.LENGTH_SHORT).show()

                                }
                                else{
                                    Toast.makeText(this@storeUserActivity, "results not found", Toast.LENGTH_SHORT).show()
    ...
    private fun getUserTypes() {
        ...
        val storeId=
            PreferenceManager.instance(this@storeUserActivity).get(PreferenceManager.STORE_ID,"1").toString()
            ...
            .subscribe(object : SingleObserver<BaseResponse> {
                ...
                override fun onSuccess(response: BaseResponse) {
                    ...
                    if(response.isIsvalid()) {
                        ...
                        Toast.makeText(this@storeUserActivity, response.message, Toast.LENGTH_SHORT).show()
                    }
                    else{
                        Toast.makeText(this@storeUserActivity, "results not found", Toast.LENGTH_SHORT).show()
                ...
                override fun onError(e: Throwable) {
                    Utils.hideDialog()
                    e.printStackTrace()
                    Toast.makeText(this@storeUserActivity, "failure", Toast.LENGTH_SHORT).show()
                }
            })
    ...
    fun updatedcitylist(cityList: MutableList<City>) {
        ...
        if(cityList !=null && cityList.size>0) {
            ...
            val adapter = ArrayAdapter<String>(this@storeUserActivity, android.R.layout.simple_spinner_dropdown_item, outlet)
